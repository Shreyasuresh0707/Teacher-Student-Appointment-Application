...
?>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Teacher's</h3>
        ...
        <div class="container">
        	<div class="card">
        			...
        			<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								...
								?>
								<h2><b>Teachers who are in titled as <?php echo $s ?></b></h2>
							</div>
						</div>
						<hr class="divider">
						<?php endif; ?>
				...
				<div class="row align-items-center">
					<div class="col-md-3">
						<img src="assets/img/<?php echo $row['img_path'] ?>" height="200px" width="150px" alt="">
					</div>
					<div class="col-md-6">
						 <p>Name: <b><?php echo "Prof. ".$row['name'].', '.$row['name_pref'] ?></b></p>
						 ...
						 <p><small><a href="javascript:void(0)" class="view_schedule" data-id="<?php echo $row['id'] ?>" data-name="<?php echo "Prof. ".$row['name'].', '.$row['name_pref'] ?>"><i class='fa fa-calendar'></i> Schedule</a></b></small></p>
						 <p><b>Specialties:</b></p>
					...
					<div class="col-md-3 text-center align-self-end-sm">
						<button class="btn-outline-primary  btn  mb-4 set_appointment" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo "Prof.  ".$row['name'].', '.$row['name_pref'] ?>">Set Appointment</button>
					</div>
				</div>
    ...
    <script>
       ...
       $('.view_schedule').click(function(){
			uni_modal($(this).attr('data-name')+" - Schedule","view_teacher_schedule.php?id="+$(this).attr('data-id'))
		})
